...
- Episode 03 uses episode-03-pages.json and ten images under /comics/episode-03-v1/. The approved 46-panel script is docs/comic/episode-03-storyboard-review-v1.md, not a client import. Existing companions enter directly; episode two's final right arrow continues into episode three.
- Episode 04 uses episode-04-pages.json and ten images under /comics/episode-04-v1/. The approved 46-panel script is docs/comic/episode-04-storyboard-review-v1.md, not a client import. No new named characters; episode three's final right arrow continues directly into episode four.
